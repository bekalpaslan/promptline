...
//   node scripts/tokens.mjs --shim design/dist/shim.css   the bundle's variable shim
//
...
/** The shim the design bundle appends after index.css: every CSS variable the
 *  app reads, pointed at the artifact's token of the same meaning, so previews
 *  in the Design System artifact follow tokens.css live. Fonts are literal
 *  (the artifact's --font-sans would loop back through --app-font). */
