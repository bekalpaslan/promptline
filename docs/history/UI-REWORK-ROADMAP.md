...
> Two deliberate deviations at the time: the popup's two bottom meta-bars
> (hint + clipboard preview) were kept separate rather than merged (2.6) —
> since resolved on 2026-08-15 by removing the clipboard bar (see BACKLOG.md)
> — and the long-term "direct API call" variant of 4.4 remains future work.
